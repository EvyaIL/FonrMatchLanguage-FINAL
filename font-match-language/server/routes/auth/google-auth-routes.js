...
router.get('/google', (req, res, next) => {
  ...
  passport.authenticate('google', { 
    scope: ['profile', 'email'],
    session: true, // Enable session for storing returnTo
...
router.get('/google/callback', (req, res, next) => {
  ...
  passport.authenticate('google', { 
    session: true, // Keep session enabled
    failureRedirect: '/login.html?error=google_auth_failed' // Redirect on failure
  }, (err, user, info) => {
    if (err) {
